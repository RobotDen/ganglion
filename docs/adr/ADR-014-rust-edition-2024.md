...
Ganglion targets Rust 1.85+ and was started after edition 2024's stabilization.
...
- **Negative:** Contributors with Rust < 1.85 cannot build the project. Documented in README and QUICKSTART.
